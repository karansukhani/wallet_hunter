...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<FamilyMemberEntity>[] is M) {
      return data.map<FamilyMemberEntity>((Map<String, dynamic> e) => FamilyMemberEntity.fromJson(e)).toList() as M;
    }
    if (<HeadModelEntity>[] is M) {
      return data.map<HeadModelEntity>((Map<String, dynamic> e) => HeadModelEntity.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (FamilyMemberEntity).toString(): FamilyMemberEntity.fromJson,
    (HeadModelEntity).toString(): HeadModelEntity.fromJson,
  };
